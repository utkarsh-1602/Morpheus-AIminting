...
function App() {
  ...
  const createImage = async () => {
    ...
    const img = `data:${type};base64,` + base64data // this is so we can render it on page 
    setImage(img)
  ...
  return (
    <div>
      ...
      {!isWaiting && url && (
        <p style={{"color": "white"}}>View&nbsp;<a href={url} target='_blank' rel='noreferrer' style={{"color":"white", "textDecoration":"none", "border": "solid 1px", "padding": "4px"}}>Metadata</a></p>
      )}
    </div>
  );
}
